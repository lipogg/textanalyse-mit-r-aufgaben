...
date: "Abgabe bis 5.1.2024, 23:59 Uhr per Mail: l.poggel@fu-berlin.de"
output: pdf_document
...
Lest euch nochmal das neue Kapitel "Textanalyse III" auf unserer Kurs-Website durch. Lest dabei auch den neuen Abschnitt "8.4.4 Was bedeutet das gemeinsame Vorkommen zweier Wörter?". Formuliert eine Frage zu einem Inhalt, der euch noch nicht ganz klar ist.
...
* Wortwolke
* Bestimmung von N-Grammen
* Bestimmung von Kookkurrenzen
* Bestimmung von Kollokationen

\vspace{4mm}

3.) Wie heißen die beiden Matrizen a) und b) in Quanteda? Erläutert außerdem in einem Satz, was jede Matrix darstellt. 

\begin{figure}[ht]
\centering
\textbf{a)} 
\includegraphics[width=0.4\textwidth]{images/matrix_1.png}
\hspace{5mm} 
\textbf{b)} 
\includegraphics[width=0.4\textwidth]{images/matrix_2.png}
\end{figure}
