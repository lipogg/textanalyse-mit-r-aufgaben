...
quiz(
  caption = "",
  question("Welche ist die korrekte Syntax für den Schleifenkopf einer for-Schleife?",
  ...
  question("Welche Syntax ist korrekt für den Schleifenkopf einer while-Schleife?",
